...
import cli_args
parser = argparse.ArgumentParser(description="Experiment 5: Inject ACT predicted hand positions + Smoothed GT velocities to tracking policy.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.video:
        video_kwargs = {
            "video_folder": os.path.join(log_dir, "videos", "exp5_inject_pred_pos_smooth_vel"),
    ...
    print(f"[INFO] Mode: Experiment 5 - Inject ACT hand positions + Smoothed GT velocities")
    ...
    print(f"\n[INFO] Starting Experiment 5: ACT Hand Positions + Smoothed GT Velocities")
    ...
    print(f"[INFO] Tracking policy receives: ACT hand positions + Smoothed GT velocities")
    ...
    while simulation_app.is_running():
        ...
        if timestep % 50 == 0:
            ...
            print(f"\n[Step {timestep}] Experiment 5: ACT Positions + Smoothed GT Velocities")
