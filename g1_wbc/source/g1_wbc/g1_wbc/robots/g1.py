# # Copyright (c) 2025, Tingxuan Leng.
# # All rights reserved.
# #
...
# source/g1_wbc/g1_wbc/robots/g1.py
import os
...
ASSETS_ROOT = os.path.join(os.path.dirname(__file__), "..", "assets", "robots", "g1")
G1_USD_PATH = os.path.abspath(os.path.join(ASSETS_ROOT, "g1_29dof_rev_1_0.usd"))
